...
Label(root, text="This is the program", font="Helvetica 15 bold", pady=20,
      padx=30, border=3, relief=GROOVE).grid(row=0, column=3, pady=15)
...
# Checkbutton
food = Checkbutton(
    text="Check here if you want your meals at lower cost ", variable=foodvalue)
...
def submit():
    ...
    with open(f"Userinput.txt", "a") as f:
        f.write(c)
